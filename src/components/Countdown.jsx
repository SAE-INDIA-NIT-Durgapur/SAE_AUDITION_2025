...
const Countdown = () => {
  const targetDate = "2025-02-07T00:00:00"; // Set the target date to January 18, 2025.
  ...
  return (
    <div className="h-auto flex flex-col items-center p-16 bg-black">
